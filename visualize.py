...
# Track whether presentation is displayed or not
show_presentation = False

# Fancy button for toggling presentation display
if st.sidebar.button("ABOUT❓"):
    show_presentation = not show_presentation

# Display presentation if show_presentation is True
...
# chart_type = st.radio("Select Chart Type:", ('ABOUT❓','Comment-Analysis', 'Employee-Positive-Sentiment'))
